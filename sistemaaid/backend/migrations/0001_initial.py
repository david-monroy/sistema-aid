<<<<<<< HEAD
=======
# Generated by Django 4.0.3 on 2022-07-16 18:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.IntegerField()),
                ('totalMuestra', models.IntegerField()),
                ('participante', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.participante')),
            ],
        ),
        migrations.AddField(
            model_name='edicion',
