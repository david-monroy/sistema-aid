# Generated by Django 4.0.3 on 2022-08-09 22:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.encuesta')),
                ('pregunta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.preguntaedicion')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='encuesta',
            name='participante',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.participante'),
        ),
        migrations.AddField(
            model_name='edicion',
            name='estudio',
